                ...
                <div class="details personal">
                    ...
                    <div class="fields">
                        ...
                        <div class="input-field">
                            ...
                            <input type="password" name="re-psw" placeholder="Enter repeat password" required>
                        </div>
                        <div class="input-field">
                        ...
                        <div class="input-field">
                            ...
                            <input type="text" name="mobile" placeholder="Enter phone numnber" required>
                        </div>
                    ...
                    <p class="signup">Already have a account ? <a href="index.php">Login Page</a></p>
                </div> 
            </div>
